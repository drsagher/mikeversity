...
export default function HeroComponent(){
    return (
        <div className="flex clear-both relative">
            ...
            <div className={'sm:hidden flex flex-col items-start p-1 ml-2 mt-2 absolute border-2 border-gray-100 hover:border-red-600 w-[40%] sm:left-2 sm:top-8 lg:top-[30%] sm:p-1 lg:p-8 lg:rounded-xl hover:bg-indigo-900 hover:text-gray-300 hover:skew-x-2'}>
