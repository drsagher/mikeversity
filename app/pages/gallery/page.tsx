...
export default function GalleryPage(){
    return(
        <div className={'mx-auto bg-gray-50 p-8'}>
            <p className={'flex items-center gap-4 text-3xl font-bold uppercase py-6 text-red-600'}><GrGallery size={55}/>
                Gallery</p>
            <div className={'flex flex-col items-center justify-center'}>
                <p className={'text-xl font-bold text-indigo-800 uppercase'}>CHAIRMAN AND SPEAKER conference MYEP AT QAU</p>
                <div className={'grid grid-cols-1 lg:grid-cols-3 justify-center items-center gap-8 py-6'}>
            ...
            <div className={'flex flex-col items-center justify-center'}>
                ...
                <div className={'grid grid-cols-1 lg:grid-cols-3 justify-center items-center gap-8'}>
            ...
            <div className={'flex flex-col items-center justify-center '}>
                ...
                <div className={'grid grid-cols-1 lg:grid-cols-2 justify-center items-center gap-8'}>
